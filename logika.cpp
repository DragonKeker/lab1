#include "logika.h"
	...
	void logika::_sravnenie(const logika& obj2)const
	{
		...
		{
			std::cout << " оличество единиц в первом числе больше" << std::endl;
		}
		else if (this->_count1() < obj2._count1())
		{
			std::cout << " оличество единиц во втором числе больше" << std::endl;
		}
		else
		{
			std::cout << " оличество единиц в числах равно"<< std::endl;
		}
	}; //делаем лабы
